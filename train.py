...
if __name__ == "__main__":
    ...
    # Training parameters
    parser.add_argument('--epochs', type = int, default = 130, help = 'number of epochs of training')
    parser.add_argument('--resume', type = bool, default = True) # action='store_true'
    ...
    parser.add_argument('--init_type', type = str, default = 'kaiming', help = 'the initialization type') # xavier
    parser.add_argument('--init_gain', type = float, default = 0.02, help = 'the initialization gain')
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = '/home/zhao/pytorch3d/output_singleview', help = 'the training folder') #output_multiview
